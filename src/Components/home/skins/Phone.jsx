...
const Phone = ({phone}) => {
  ...
  async function Addtocart() {
    if (user) {
      ...
      await axios
        .post("https://emarketbackendd.onrender.com/addtocartfromphone", cartdetails)
        .then((res) => {
          const da = res.data;
  ...
  return (
    <div class="product-container">
      <div class="product-card">
        ...
        <Link to={`/details/${phone._id}`}> <img src={phone.imageurls} alt="Product 1" class="product-image"/></Link>
